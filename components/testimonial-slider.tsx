        ...
        >
          {testimonials.map((testimonial) => (
            <div key={testimonial.id} className="w-full flex-shrink-0 px-4 md:px-12">
              <div className="bg-card rounded-2xl p-6 md:p-8 shadow-elegant flex flex-col items-center text-center">
                ...
                <div>
                  <div className="font-playfair font-semibold text-lg">{testimonial.name}</div>
