    ...
    <div className="py-8 md:py-12">
        ...
        <div className="container-custom">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-elegant-lg">
              <Image src="/images/about-hero.png" alt="Arpan Decores workshop" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-royal-cream/30">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="relative h-48 w-48 rounded-full overflow-hidden mx-auto mb-4 shadow-elegant">
                <Image src="/images/artisan-2.png" alt="Priya Sharma - Design Lead" fill className="object-cover" />
              </div>
      ...
      <section className="section-padding bg-background">
        <div className="container-custom">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-elegant-lg">
              <Image src="/images/workshop.png" alt="Our workshop" fill className="object-cover" />
            </div>
            <div className="space-y-6">
